    ...
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="flex items-center space-x-4">
                <button wire:click="clearLogs" onclick="confirm('Are you sure you want to clear all HTTP logs?') || event.stopImmediatePropagation()" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none transition ease-in-out duration-150">
